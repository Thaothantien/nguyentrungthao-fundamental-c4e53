const cauHoi = document.getElementById("hienthi")
const cauHoi2 = document.getElementById("hienthi2")
...
nutBam.addEventListener('click', () => {
    let show = quote[Math.floor(Math.random() * quote.length)]
        cauHoi.innerText = show.quoteText
        cauHoi2.innerText = show.quoteAuthor
}) 